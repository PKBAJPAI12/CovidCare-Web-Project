...
<head>
  <!-- Required meta tags -->
  <!--   Covid Api district wise :    https://data.covid19india.org/state_district_wise.json-->

  <!-- statewise covid stats: https://data.covid19india.org/data.json    
   https://api.rootnet.in/covid19-in/stats/latest   -->

   <!-- hospital bedsapi https://api.rootnet.in/covid19-in/hospitals/beds -->

   <!-- contacts & helpline https://api.rootnet.in/covid19-in/contacts -->
   <!-- covid notification https://api.rootnet.in/covid19-in/notifications -->
  <meta charset="utf-8">
...
?>
      ...
      <div class="col-md-3">
        <div class="card border border-dark" id="card1">
          <div class="card-body">
            ...
            <h5 class="card-title text-center" id="active"></h5>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="card border border-dark" id="card2">
          <div class="card-body">
            ...
            <h5 class="card-title text-center" id="discharged"></h5>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3">
        <div class="card border border-dark" id="card3">
          <div class="card-body">
            ...
            <h5 class="card-title text-center" id="death"></h5>
          </div>
        </div>
      </div>
  ...
  <div class="d-flex justify-content-center mx-3 my-8">
    <div id="left" class="leftm">
      <img src="vaccine-5454099_640.jpg" alt="" srcset="">
    </div>
    <div class="rightm">
      <a href="covidvaccine.php"><button type="button" id="btn" class="btn btn-success center">Covid-19 Vaccine
          Registeration</button></a>
  ...
  <div class="trackerstates mx-3 my-5">
    ...
    <table class="table border border-dark my-4" id="table" >
        <tr>
  ...
  <div class="footer">
    ...
    <div class="copyright">
      <p><b>CovidHelp System</b> is Developed by <span>&copy;<span> Prateek Bajpai</p>
    </div>
  </div>
